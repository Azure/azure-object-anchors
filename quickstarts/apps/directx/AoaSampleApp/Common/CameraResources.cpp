...
AoaSampleApp::CameraResources::CameraResources(HolographicCamera const& camera) :
...
void AoaSampleApp::CameraResources::CreateResourcesForBackBuffer(
    AoaSampleApp::DeviceResources* pDeviceResources,
...
void AoaSampleApp::CameraResources::ReleaseResourcesForBackBuffer(AoaSampleApp::DeviceResources* pDeviceResources)
{
...
void AoaSampleApp::CameraResources::UpdateViewProjectionBuffer(
    std::shared_ptr<AoaSampleApp::DeviceResources> deviceResources,
...
)
{
    ...
    AoaSampleApp::ViewProjectionConstantBuffer viewProjectionConstantBufferData;
...
bool AoaSampleApp::CameraResources::AttachViewProjectionBuffer(
    std::shared_ptr<AoaSampleApp::DeviceResources>& deviceResources
)
{
