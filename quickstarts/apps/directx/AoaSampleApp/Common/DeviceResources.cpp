...
AoaSampleApp::DeviceResources::DeviceResources()
{
    CreateDeviceIndependentResources();
}

// Configures resources that don't depend on the Direct3D device.
void AoaSampleApp::DeviceResources::CreateDeviceIndependentResources()
{
...
void AoaSampleApp::DeviceResources::SetHolographicSpace(HolographicSpace holographicSpace)
{
...
void AoaSampleApp::DeviceResources::InitializeUsingHolographicSpace()
{
...
void AoaSampleApp::DeviceResources::CreateDeviceResources()
{
...
#if defined(_DEBUG)
    if (AoaSampleApp::SdkLayersAvailable())
    {
...
void AoaSampleApp::DeviceResources::EnsureCameraResources(
...
// Locks the set of holographic camera resources until the function exits.
void AoaSampleApp::DeviceResources::AddHolographicCamera(HolographicCamera camera)
{
...
// Locks the set of holographic camera resources until the function exits.
void AoaSampleApp::DeviceResources::RemoveHolographicCamera(HolographicCamera camera)
{
    UseHolographicCameraResources<void>([this, camera](std::map<UINT32, std::unique_ptr<CameraResources>>& cameraResourceMap)
    {
...
// Locks the set of holographic camera resources until the function exits.
void AoaSampleApp::DeviceResources::HandleDeviceLost()
{
...
void AoaSampleApp::DeviceResources::RegisterDeviceNotify(AoaSampleApp::IDeviceNotify* deviceNotify)
{
...
void AoaSampleApp::DeviceResources::Trim()
{
...
// Locks the set of holographic camera resources until the function exits.
void AoaSampleApp::DeviceResources::Present(HolographicFrame const& frame)
{
